let guests: string[] = ["Yasin", "Haris", "Shahzaib", "Muzamil", "Abdullah"];
for (let i = 0; i < guests.length; i++) {
  console.log(
    `Hello ${guests[i]}, you are invited to dinner at 8:00 PM on 25th of August 2023`
  );
}

let cantMakeIt: string = guests.pop()!;
...
console.log("\nUnfortunately, the new dinner table won't arrive in time. We can only invite two people.");
...
console.log(`\nDear ${guests[0]} and ${guests[1]},You are still invited to the dinner.\n`);
